...
import { normalizeCountries } from "./foreign.js";
...
export function encodePrefs(prefs = {}) {
  return JSON.stringify({
    ...
    countries: normalizeCountries(prefs.countries),
...
export function decodePrefs(raw) {
  ...
  return {
    ...
    countries: normalizeCountries(
      Array.isArray(parsed.countries) ? parsed.countries.filter((c) => typeof c === "string") : []
    ),

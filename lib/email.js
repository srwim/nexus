...
// extras: { sponsor: {title, body, url, cta}, siteUrl: "https://..." }
...
<html><body style="margin:0;padding:0;background:#f4f4f5;font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="padding:24px 12px;">
    <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
      ...
      <tr><td style="padding:16px;text-align:center;color:#9ca3af;font-size:11px;">Curated by your topic ratings · NEXUS</td></tr>
    </table>
  </td></tr></table>
</body></html>`;
}

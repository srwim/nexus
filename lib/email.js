...
function sponsorTopHtml(sp, t) {
  ...
  return `<div style="margin-top:14px;padding-top:12px;border-top:1px solid ${t.headRule};">
    <div style="font-size:10px;letter-spacing:1.5px;text-transform:uppercase;color:${t.muted};margin-bottom:4px;">Sponsored by</div>

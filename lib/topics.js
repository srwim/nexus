...
export const TOPICS = {
  ...
  foreign: {
    label: "Foreign Reporting",
    icon: "🌐",
    feeds: [], // dynamic: native-language feeds per country, prebuilt into data/foreign.json
    hasCountries: true,
  },
  world: {
    label: "World News",
...
export const DEFAULT_PREFS = {
  ...
  leagues: ["nfl", "nba"],
  // Literal, not imported from lib/foreign.js: that module reaches rank.js,
  // which reaches back here, and a cycle through DEFAULT_PREFS would depend on
  // module evaluation order. A test keeps the two lists in step instead.
  countries: ["jp", "de", "fr", "br", "eg"],
  ratings: {
    politics: 3,
    foreign: 3,
    usnews: 3,
